...
@router.post(
    ...
    description="Records a sale and atomically deducts stock."
)
...
@router.get(
    ...
    description="Returns paginated sales history for a specific product."
)
...
@router.get(
    ...
    description="Returns all sales for a product between start_date and end_date."
)
@limiter.limit("60/minute")
...
@router.get(
    ...
    description="Returns total revenue in cents and dollars for a product."
)
@limiter.limit("60/minute")
...
@router.get(
    ...
    description="Returns a single sale record by its UUID."
)
@limiter.limit("60/minute")
def read_sale(
    request: Request,
...
@router.delete(
    ...
    description="Permanently deletes a sale record. Use only for correcting data entry errors."
)
@limiter.limit("30/minute")
def delete_sale(
    request: Request,
